...
If you want a ready-made QR payload to decode (or to validate another implementation), use the repo's [test vectors](https://github.com/idpass/claim-169/tree/main/test-vectors/valid):
